...
pub struct Params {
    ...
    pub ntrn_prices: ::prost::alloc::vec::Vec<
        super::cosmos_sdk_proto::cosmos::base::v1beta1::DecCoin,
    >,
}
impl ::prost::Name for Params {
    const NAME: &'static str = "Params";
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.Params".into()
    }
...
impl ::prost::Name for MsgUpdateParams {
    ...
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.MsgUpdateParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/neutron.dynamicfees.v1.MsgUpdateParams".into()
    }
...
impl ::prost::Name for MsgUpdateParamsResponse {
    ...
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.MsgUpdateParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/neutron.dynamicfees.v1.MsgUpdateParamsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/neutron.dynamicfees.v1.Msg/UpdateParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("neutron.dynamicfees.v1.Msg", "UpdateParams"));
...
pub mod msg_server {
    ...
    pub const SERVICE_NAME: &str = "neutron.dynamicfees.v1.Msg";
...
impl ::prost::Name for QueryParamsRequest {
    ...
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.QueryParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/neutron.dynamicfees.v1.QueryParamsRequest".into()
    }
...
impl ::prost::Name for QueryParamsResponse {
    ...
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.QueryParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/neutron.dynamicfees.v1.QueryParamsResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("neutron.dynamicfees.v1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "neutron.dynamicfees.v1.Query";
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "neutron.dynamicfees.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "neutron.dynamicfees.v1.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/neutron.dynamicfees.v1.GenesisState".into()
    }
